export const metadata = {
  ...
  alternates: {
   ...
   openGraph: {
    title: 'Building the Future of Video Resumes with AI',
    description: 'Rethinking professional storytelling through interactive video, AI, and UX design.',
    url: 'https://lanreadebayo.com/blog/video-resume-ai',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1758521540165-b7e99f9a98ce?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2232', // You can create specific OG images for each post
        width: 1200,
        height: 630,
        alt: 'Building the Future of Video Resumes with AI',
      },
    ],
  },
  twitter: {
